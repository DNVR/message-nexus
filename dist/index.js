...
var fixes_1 = __importDefault(require("./fixes"));
var MessageNexusArgsMap = new WeakMap;
var MessageNexusEvent = /** @class */ (function (_super) {
    __extends(MessageNexusEvent, _super);
    function MessageNexusEvent(type, _a) {
        var args = _a.args;
        var _this = _super.call(this, type) || this;
        MessageNexusArgsMap.set(_this, _this.args = args);
        return _this;
    }
    Object.defineProperty(MessageNexusEvent.prototype, "args", {
        get: function () {
...
var MessageNexus2Target = new WeakMap;
var MessageNexus2FunctionMap = new WeakMap;
var MessageNexus = /** @class */ (function () {
    function MessageNexus() {
    ...
    MessageNexus.prototype.neglect = function (type, callback) {
        ...
        var list = MessageNexus2FunctionMap.get(this);
        if (list.has(callback)) {
            void MessageNexus2Target.get(this).removeEventListener(type, list.get(callback), listenerOptions);
        }
    };
    return MessageNexus;
}());
exports.default = MessageNexus;
